                ...
                <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
                    <div class="u-sidenav-overflow">
                        ...
                        <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                            <li class="u-nav-item"><a class="u-button-style u-nav-link" href="Team.html" style="padding: 10px 20px;">Main</a></li>
                            <li class="u-nav-item"><a class="u-button-style u-nav-link" href="${pageContext.request.contextPath}/person?id=1" style="padding: 10px 20px;">Vladislav Bardin</a></li>
                            <li class="u-nav-item"><a class="u-button-style u-nav-link" href="${pageContext.request.contextPath}/person?id=2" style="padding: 10px 20px;">Artur Zadniprianets</a></li>
                            <li class="u-nav-item"><a class="u-button-style u-nav-link" href="${pageContext.request.contextPath}/person?id=3" style="padding: 10px 20px;">Olexii Kurkin</a></li>
                        </ul>
                    </div>
                </div>
...
<section class="u-align-left u-clearfix u-section-1" id="sec-32dc">
